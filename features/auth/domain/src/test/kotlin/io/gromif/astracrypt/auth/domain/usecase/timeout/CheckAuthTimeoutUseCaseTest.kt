...
class CheckAuthTimeoutUseCaseTest {
    ...
    @Before
    fun setUp() {
        checkAuthTimeoutUseCase = CheckAuthTimeoutUseCase(getAuthUseCase, clockService)
    }

    @Test
    fun `should correctly validate AuthTimeout and return the result`() = runTest {
        ...
        val result = checkAuthTimeoutUseCase()
