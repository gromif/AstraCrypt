...
class LabAeadManager(
    ...
    suspend fun startFilesWorker(
        ...
        val data = Data.Builder().apply {
            putStringArray(LabFilesWorker.Args.sourceUriArray, arrayOf(filesSourceUri!!.toString()))
            putString(LabFilesWorker.Args.destinationUri, filesDestinationUri!!.toString())
            putString(LabFilesWorker.Args.encryptedAssociatedData, encryptedAssociatedData)
            putString(LabFilesWorker.Args.encryptedKeyset, encryptedKeyset)
