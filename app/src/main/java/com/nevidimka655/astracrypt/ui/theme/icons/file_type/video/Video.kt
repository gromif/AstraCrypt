package com.nevidimka655.astracrypt.ui.theme.icons.file_type.video
...
val _FileType.Video @Composable get() = icon()
...
private fun icon(): VectorPainter {
    val colorScheme = MaterialTheme.extendedColorScheme.violet
    val foreground = colorScheme.onColorContainer
    return rememberVectorPainter(
        _FileType.Builder.videoAlt(foreground = foreground)
    )
}